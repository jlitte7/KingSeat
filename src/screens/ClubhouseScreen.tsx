...
type ClubhouseNavigationProp = NativeStackNavigationProp<RootStackParamList, 'Clubhouse'>;

export default function ClubhouseScreen() {
  const navigation = useNavigation<ClubhouseNavigationProp>();
  const { teams, deleteTeam } = useTossSeriesStore();
    ...
    <SafeAreaView className="flex-1 bg-gray-900">
      <View className="flex-1">
        <View className="px-4 py-3 flex-row items-center justify-between border-b border-gray-800">
          ...
          <Pressable onPress={() => navigation.navigate('CreateTeam')} className="bg-blue-600 px-4 py-2 rounded-lg">
                  ...
                  >
                    ...
                    <View className="flex-row">
                      <View className="flex-1 items-center bg-gray-900/50 rounded-lg py-2">
                        ...
                        <Text className="text-white font-bold text-lg">{team.stats.totalWins}</Text>
                      </View>
                      <View className="w-2" />
                      <View className="flex-1 items-center bg-gray-900/50 rounded-lg py-2">
                        <Text className="text-gray-400 text-xs">Losses</Text>
                        <Text className="text-white font-bold text-lg">{team.stats.totalLosses}</Text>
                      </View>
                      <View className="w-2" />
                      <View className="flex-1 items-center bg-gray-900/50 rounded-lg py-2">
                        <Text className="text-gray-400 text-xs">Games</Text>
                        <Text className="text-white font-bold text-lg">{team.stats.totalGames}</Text>
                      </View>
                    </View>
                  </LinearGradient>
                </View>
